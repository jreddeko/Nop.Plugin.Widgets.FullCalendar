...
namespace Nop.Plugin.Widgets.FullCalendar.Data
{
    ...
    /// Object context
    /// </summary>
    public class FullCalendarObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public FullCalendarObjectContext(string nameOrConnectionString)
        ...
        {
            //drop the table
            var tableName = this.GetTableName<Appointment>();
